...
module.exports = {
  ...
  microservices: {
    allInclusive: 'stvgroup-staging.grdnz.com',
    integrationAPI: 'stvgroup-staging.grdnz.com',
    integrationAPIAuthToken: 'testtokenforgas',
    analytics: 'analytics.stvgroup-staging.grdnz.com:3000',
    mondrian: 'mdx.stvgroup-staging.grdnz.com:8080/mdx',
    GAA: 'stvgroup-staging.grdnz.com',
    apiGateway: 'stvgroup-staging.grdnz.com',
    druid: 'analytics.stvgroup-staging.grdnz.com:8082'
  },
  ...
  GAA: {
    analyticsLastUpdateUrl: 'http://analytics.stvgroup-staging.grdnz.com:3000/lastupdate',
    druid: {
      dataSource: {
        debtGatheringName: 'debt_gathering_stvgroup_production',
        salesName: 'sales_stvgroup_production'
      }
    }
  },
  ...
  cors: {
    origin: 'http://stvgroup-staging.grdnz.com',
    credentials: true
  }
