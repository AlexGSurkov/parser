...
describe('IntegrationAPI MetaController Test', () => {
  ...
  describe("#findOne", () => {
    ...
    it('it should find resource in different registers', () => {
      return helpers.makeRequest('get', '/api/resources/meta/user').then(res => {
    ...
    it('it should not find resource', () => {
      return helpers.makeRequest('get', '/api/resources/meta/unknownresource').then(res => {
