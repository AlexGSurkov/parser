...
module.exports = {
  up(queryInterface, Sequelize) {
    return migration(queryInterface, Sequelize, '/sqls/20180830122925-create-vessels-up.sql');
  },

  down(queryInterface, Sequelize) {
    return migration(queryInterface, Sequelize, '/sqls/20180830122925-create-vessels-down.sql');
  }
};
